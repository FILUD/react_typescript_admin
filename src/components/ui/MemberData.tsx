    ...
    return (
        <main className='bg-white p-5 rounded-lg h-[330px]'>
            <li className='text-[24px] font-semibold flex gap-5 items-center'>
                ...
                Product Data</li>
            <hr />
            <div className='flex flex-col gap-5 py-5 h-[200px] overflow-y-auto'>
            ...
            <hr />
            <span className='flex gap-3 items-center hover:bg-slate-300 duration-300 mt-5 py-1 font-semibold justify-center cursor-pointer  rounded-xl'>
                View all
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
